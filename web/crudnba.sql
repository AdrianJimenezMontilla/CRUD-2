...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-05-2019 a las 11:33:31
...
(3, 'Pepito', 30, 'Alero', 200, 100, 15),
(4, 'James Harden', 28, 'Base', 196, 102, 18),
...
(19, 'Quber', 34, 'Alero', 201, 110, 7),
(20, 'Piter', 20, 'Alero', 200, 100, 10),
(30, 'prueba2', 32, 'Alero', 201, 110, 4);
...
INSERT INTO `usuario` (`id`, `login`, `password`, `nivel`) VALUES
(1, 'usuario', 'usuario', 2),
(2, 'pepe', 'palotes', 2),
(3, 'adrian', '1234', 2),
(4, 'admin', 'admin', 1);
...
--
ALTER TABLE `jugadores`
  MODIFY `CodJug` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
