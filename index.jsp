        ...
        <form method="get" action="nuevoJugador.jsp">
          <tr><td><input type="text" name="CodJug" size="2"></td>
              ...
              <td><select name="CodEqui">
                ...
                <option value="3">Boston Celtics</option>
                <option value="4">Toronto Raptors</option>
                <option value="5">Houston Rockets</option>
                <option value="6">Oklahoma City Thunder</option>
                <option value="7">Milwaukee Bucks</option>
                <option value="8">San Antonio Spurs</option>
                <option value="9">Philadelphia 76ers</option>
                <option value="10">New York Knicks</option>
                <option value="11">Chicago Bulls</option>
                <option value="12">Miami Heat</option>
                <option value="13">Cleveland Cavaliers</option>
                <option value="14">Denver Nuggets</option>
                <option value="15">Dallas Mavericks</option>
                <option value="16">Sacramento Kings</option>
                <option value="17">Los Angels Clippers</option>
                <option value="18">Utah Jazz</option>
                <option value="19">New Orleans Pelicans</option>
                <option value="20">Portland Trail Blazers</option>
              </select></td>
